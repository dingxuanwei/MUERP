...
(function ($) {
    ...
    function _49(_4a, _4b) {
        ...
        function _4e(_4f) {
            var _50 = _4f ? 1 : 2;
            var tr = _4d.finder.getTr(_4a, _4b, "body", _50); (_4f ? dc.body1 : dc.body2).children("table.datagrid-btable-frozen").append(tr);
        };
    };
            ...
            if ($.isArray(_5f.toolbar)) {
                ...
                for (var i = 0; i < _5f.toolbar.length; i++) {
                    ...
                    if (btn == "-") {
                        ...
                        _65[0].onclick = eval(btn.handler ||
                        function () { });
                        _65.linkbutton($.extend({},
                        btn, {
                            plain: true
                        }));
                    }
                ...
                for (var j = 0; j < _6f.length; j++) {
                    ...
                    if (col.checkbox) {
                        ...
                        if (col.field) {
                            ...
                            col.cellClass = _5e.cellClassPrefix + "-" + col.field.replace(/[\.|\s]/g, "-").replace(/./g,
                            function ($1) {
    ...
    function _77(_78) {
        ...
        _7c.find("input[type=checkbox]").unbind(".datagrid").bind("click.datagrid",
        function (e) {
        ...
        _7d.closest("td").unbind(".datagrid").bind("mouseenter.datagrid",
        function () {
            if (_79.resizing) {
                return;
            }
        ...
        _7d.unbind(".datagrid").bind("click.datagrid",
        function (e) {
    ...
    function _b2(_18e, _18f) {
        ...
        var _191 = opts.loader.call(_18e, _190,
        function (data) {
    ...
    var _1a9 = $.extend({},
    _19b(["text", "textbox", "numberbox", "numberspinner", "combobox", "combotree", "combogrid", "datebox", "datetimebox", "timespinner", "datetimespinner"]), {
        textarea: {
    ...
    $.fn.datagrid.parseOptions = function (_1ef) {
        var t = $(_1ef);
        return $.extend({},
        $.fn.panel.parseOptions(_1ef), $.parser.parseOptions(_1ef, ["url", "toolbar", "idField", "sortName", "sortOrder", "pagePosition", "resizeHandle", {
    ...
    var _1f2 = {
        render: function (_1f3, _1f4, _1f5) {
        ...
        renderEmptyRow: function (_238) {
            var cols = $.map($(_238).datagrid("getColumnFields"),
            function (_239) {
    ...
    $.fn.panel.defaults, {
        ...
        editors: _1a9,
        finder: {
            getTr: function (_240, _241, type, _242) {
                type = type || "body";
                _242 = _242 || 0;
