...
(function ($) {
    ...
    function _2(_3) {
        ...
        $(_3).addClass("combo-f").textbox($.extend({},
        _5, {
            icons: _a,
            onChange: function () { }
        }));
    ...
    $.fn.combo = function (_4f, _50) {
        ...
        return this.each(function () {
            ...
            if (_52) {
                ...
                _52 = $.data(this, "combo", {
                    options: $.extend({},
                    $.fn.combo.defaults, $.fn.combo.parseOptions(this), _4f),
                    previousText: ""
                });
    ...
    $.fn.combo.parseOptions = function (_5a) {
        var t = $(_5a);
        return $.extend({},
        $.fn.textbox.parseOptions(_5a), $.parser.parseOptions(_5a, ["separator", "panelAlign", {
            panelWidth: "number",
