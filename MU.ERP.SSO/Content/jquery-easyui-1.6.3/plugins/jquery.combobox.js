...
(function ($) {
        ...
        return this.each(function () {
            ...
            if (_5e) {
                ...
                _5e = $.data(this, "combobox", {
                    options: $.extend({},
                    $.fn.combobox.defaults, $.fn.combobox.parseOptions(this), _5b),
                    data: []
                });
            }
            _47(this);
    ...
    $.fn.combobox.parseOptions = function (_6c) {
        var t = $(_6c);
        return $.extend({},
        $.fn.combo.parseOptions(_6c), $.parser.parseOptions(_6c, ["valueField", "textField", "groupField", "groupPosition", "mode", "method", "url", {
