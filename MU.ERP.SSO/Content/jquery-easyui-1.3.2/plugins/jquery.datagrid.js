...
(function ($) {
    ...
    function _2c(_2d, _2e) {
        ...
        function _31(_32) {
            var _33 = _32 ? 1 : 2;
            var tr = _30.finder.getTr(_2d, _2e, "body", _33); (_32 ? dc.body1 : dc.body2).children("table.datagrid-btable-frozen").append(tr);
        };
    };
                ...
                for (var j = 0; j < _58.length; j++) {
                    ...
                    if (col.checkbox) {
                        ...
                        if (col.field) {
                            ...
                            col.cellClass = "datagrid-cell-c" + _1 + "-" + col.field.replace(/[\.|\s]/g, "-").replace(/./g,
                            function ($1) {
    ...
    function _5d(_5e) {
        ...
        _62.find("input[type=checkbox]").unbind(".datagrid").bind("click.datagrid",
        function (e) {
        ...
        _63.unbind(".datagrid").bind("click.datagrid",
        function (e) {
    ...
    function _103(_104, _105) {
        ...
        //easyuifix.datagrid_afterCreateEditor(_104, _105, row);
        _108(_104, _105);
    };
    function _109(_10a, _10b, _10c) {
        ...
        //easyuifix.datagrid_beforeDestroyEditor(_10a, _10b, row);
    ...
    function _142(_143) {
        ...
        function _14b(ids, _14c) {
            for (var i = 0; i < ids.length; i++) {
                var _14d = _b4(_143, ids[i]); (_14c == "s" ? _ca : _d2)(_143, _14d, true);
            }
        };
    ...
    var _15e = {
        ...
        checkbox: {
            ...
            setValue: function (_173, _174) {
                var _175 = false;
                //_175 = easyuifix.datagrid_editors_checkboxVal(_173, _174);
                if ($(_173).val() == _174) {
                    _175 = true;
                }
    ...
    $.fn.datagrid.parseOptions = function (_1c8) {
        var t = $(_1c8);
        return $.extend({},
        $.fn.panel.parseOptions(_1c8), $.parser.parseOptions(_1c8, ["url", "toolbar", "idField", "sortName", "sortOrder", "pagePosition", "resizeHandle", {
            fitColumns: "boolean",
