...
(function ($) {
    ...
    function _2c(_2d, _2e, _2f) {
        ...
        //add by yrh 2012-11-12 for show blank row 
        if (_30.showblank) {
            _2e.unshift(_30.blankdefault);
        }
        //end add
    ...
    $.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults, {
        valueField: "value", textField: "text", mode: "local",
        //add by yrh 2012-11-12 for show blank row  
        showblank: false,
        blankdefault: { value: '', text: '== 请选择 ==' },
        //end add
        method: "post", url: null, data: null, keyHandler: {
            up: function () {
                _6(this);
            }, down: function () {
                _e(this);
            ...
            $.ajax({
                type: _57.method, url: _57.url, data: _54, dataType: "json", success: function (_58) {
                    _55(_58);
                }, error: function () {
