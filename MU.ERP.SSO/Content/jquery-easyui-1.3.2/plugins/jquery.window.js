...
(function ($) {
    ...
    function _17(_18) {
        ...
        var win = $(_18).panel($.extend({}, _19.options, {
            border: false, doSize: true, closed: true, cls: "window", headerCls: "window-header", bodyCls: "window-body " + (_19.options.noheader ? "window-body-noheader" : ""), onBeforeDestroy: function () {
    ...
    function _1e(_1f) {
        ...
        _20.window.draggable({
            handle: ">div.panel-header>div.panel-title", disabled: _20.options.draggable == false, onStartDrag: function (e) {
                if (_20.mask) {
                ...
                //console.log(' ----------- window onDrag 移动了 -------- e: ', e);
                _20.proxy.css({ display: "block", left: e.data.left, top: e.data.top });
                return false;
            }, onStopDrag: function (e) {
                console.log(' ---- jquery.window onStopDrag -------- e: ', e.data.left, e.data.top);
                _20.options.left = e.data.left < 0 ? 0 : e.data.left;
                _20.options.top = e.data.top < 0 ? 0 : e.data.top;
                $(_1f).window("move");
                _20.proxy.remove();
                _20.proxy = null;
            }
