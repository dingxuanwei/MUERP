...
namespace MUSystem.Utils.NPOI.HSSF.UserModel
{
    ...
    public class HSSFName:MUSystem.Utils.NPOI.SS.UserModel.IName
    {
        ...
        public String RefersToFormula
        {
            ...
            set
            {
                Ptg[] ptgs = HSSFFormulaParser.Parse(value, book, MUSystem.Utils.NPOI.SS.Formula.FormulaType.NAMEDRANGE, SheetIndex);
