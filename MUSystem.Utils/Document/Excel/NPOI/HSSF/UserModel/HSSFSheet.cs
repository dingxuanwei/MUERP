...
namespace MUSystem.Utils.NPOI.HSSF.UserModel
{
    using System;
    using System.Collections;
    using System.Collections.Generic;
    using System.Windows.Forms;
    using MUSystem.Utils.NPOI.DDF;
    using MUSystem.Utils.NPOI.HSSF.Model;
    using MUSystem.Utils.NPOI.HSSF.Record;
    using MUSystem.Utils.NPOI.HSSF.Record.Aggregates;
    using MUSystem.Utils.NPOI.HSSF.Record.AutoFilter;
    using MUSystem.Utils.NPOI.HSSF.Util;
    using MUSystem.Utils.NPOI.SS;
    using MUSystem.Utils.NPOI.SS.Formula;
    using MUSystem.Utils.NPOI.SS.Formula.PTG;
    using MUSystem.Utils.NPOI.SS.UserModel;
    using MUSystem.Utils.NPOI.SS.Util;
    ...
    /// </remarks>
    [Serializable]
    public class HSSFSheet : MUSystem.Utils.NPOI.SS.UserModel.ISheet
    {
        ...
        private Dictionary<int, MUSystem.Utils.NPOI.SS.UserModel.IRow> rows;
        ...
        /// <see cref="MUSystem.Utils.NPOI.HSSF.UserModel.HSSFWorkbook.CreateSheet()"/>
        public HSSFSheet(HSSFWorkbook workbook)
        {
            _sheet = InternalSheet.CreateSheet();
            rows = new Dictionary<int, MUSystem.Utils.NPOI.SS.UserModel.IRow>();
        ...
        /// <see cref="MUSystem.Utils.NPOI.HSSF.UserModel.HSSFWorkbook(MUSystem.Utils.NPOI.POIFS.FileSystem.DirectoryNode, bool)"/>
        ...
        public MUSystem.Utils.NPOI.SS.UserModel.IRow CreateRow(int rownum)
        {
        ...
        private int FindLastRow(int lastrow)
        {
            ...
            MUSystem.Utils.NPOI.SS.UserModel.IRow r = GetRow(rownum);
        ...
        /// <returns></returns>
        public MUSystem.Utils.NPOI.SS.UserModel.ICellStyle GetColumnStyle(int column)
        {
        ...
        public MUSystem.Utils.NPOI.SS.UserModel.IRow GetRow(int rowIndex)
        {
        ...
        [Obsolete]
        public int AddMergedRegion(MUSystem.Utils.NPOI.SS.Util.Region region)
        {
        ...
        /// <returns>index of this region</returns>
        public int AddMergedRegion(MUSystem.Utils.NPOI.SS.Util.CellRangeAddress region)
        {
        ...
        //public MUSystem.Utils.NPOI.SS.Util.Region GetMergedRegionAt(int index)
        //{
        //    MUSystem.Utils.NPOI.SS.Util.CellRangeAddress cra = GetMergedRegion(index);

        //    return new MUSystem.Utils.NPOI.SS.Util.Region(cra.FirstRow, (short)cra.FirstColumn,
        ...
        /// Call <see cref="MUSystem.Utils.NPOI.SS.UserModel.IRow.RowNum"/> on each row 
        ...
        public MUSystem.Utils.NPOI.SS.UserModel.IPrintSetup PrintSetup
        {
        ...
        public MUSystem.Utils.NPOI.SS.UserModel.IHeader Header
        {
        ...
        public MUSystem.Utils.NPOI.SS.UserModel.IFooter Footer
        {
        ...
        public void SetEnclosedBorderOfRegion(CellRangeAddress region, MUSystem.Utils.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
        ...
        /// <param name="borderType">Type of the border.</param>
        /// <param name="color">The color.</param>
        public void SetBorderRightOfRegion(CellRangeAddress region, MUSystem.Utils.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
            HSSFRegionUtil.SetRightBorderColor(color, region, this, _workbook);
            HSSFRegionUtil.SetBorderRight(borderType, region, this, _workbook);
        }
        ...
        /// <param name="borderType">Type of the border.</param>
        /// <param name="color">The color.</param>
        public void SetBorderLeftOfRegion(CellRangeAddress region, MUSystem.Utils.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
            HSSFRegionUtil.SetLeftBorderColor(color, region, this, _workbook);
            HSSFRegionUtil.SetBorderLeft(borderType, region, this, _workbook);
        }
        ...
        /// <param name="borderType">Type of the border.</param>
        /// <param name="color">The color.</param>
        public void SetBorderTopOfRegion(CellRangeAddress region, MUSystem.Utils.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
            HSSFRegionUtil.SetTopBorderColor(color, region, this, _workbook);
            HSSFRegionUtil.SetBorderTop(borderType, region, this, _workbook);
        }
        ...
        /// <param name="borderType">Type of the border.</param>
        /// <param name="color">The color.</param>
        public void SetBorderBottomOfRegion(CellRangeAddress region, MUSystem.Utils.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
            HSSFRegionUtil.SetBottomBorderColor(color, region, this, _workbook);
            HSSFRegionUtil.SetBorderBottom(borderType, region, this, _workbook);
        }
        ...
        protected void ShiftMerged(int startRow, int endRow, int n, bool IsRow)
        {
            ...
            {
                MUSystem.Utils.NPOI.SS.Util.CellRangeAddress merged = this.GetMergedRegion(i);
            ...
            {
                MUSystem.Utils.NPOI.SS.Util.CellRangeAddress region = (MUSystem.Utils.NPOI.SS.Util.CellRangeAddress)iterator.Current;
        ...
        [Obsolete]
        private static bool ContainsCell(MUSystem.Utils.NPOI.SS.Util.CellRangeAddress cr, int rowIx, int colIx)
        {
            ...
            bool copyRowHeight, bool resetOriginalRowHeight, bool moveComments)
        {
            ...
            for (int rowNum = s; rowNum >= startRow && rowNum <= endRow && rowNum >= 0 && rowNum < 65536; rowNum += inc)
            {
                ...
                foreach (ICell cell in cells)
                {
                    ...
                    MUSystem.Utils.NPOI.SS.UserModel.IHyperlink link = cell.Hyperlink;
                    if (link != null)
                    {
        ...
        public void CreateSplitPane(int xSplitPos, int ySplitPos, int leftmostColumn, int topRow, MUSystem.Utils.NPOI.SS.UserModel.PanePosition activePane)
        ...
        // public void CreateSplitPane(int xSplitPos, int ySplitPos, int topRow, int leftmostColumn, MUSystem.Utils.NPOI.SS.UserModel.PanePosition activePane)
        {
        ...
        public MUSystem.Utils.NPOI.SS.Util.PaneInformation PaneInformation
        {
            get
            {
        ...
        public double GetMargin(MUSystem.Utils.NPOI.SS.UserModel.MarginType margin)
        {
        ...
        public void SetMargin(MUSystem.Utils.NPOI.SS.UserModel.MarginType margin, double size)
        {
        ...
        public MUSystem.Utils.NPOI.SS.UserModel.IDrawing CreateDrawingPatriarch()
        {
            if (_patriarch == null)
            {
        ...
        public void SetDefaultColumnStyle(int column, MUSystem.Utils.NPOI.SS.UserModel.ICellStyle style)
        {
        ...
        public IComment GetCellComment(int row, int column)
        {
            ...
            if (r != null)
            {
                MUSystem.Utils.NPOI.SS.UserModel.ICell c = r.GetCell(column);
                if (c != null)
                {
        ...
        /// </summary>
        public MUSystem.Utils.NPOI.SS.UserModel.IWorkbook Workbook
        {
            get
            {
                return _workbook;
        ...
        public String SheetName
        {
            get
            {
                MUSystem.Utils.NPOI.SS.UserModel.IWorkbook wb = Workbook;
