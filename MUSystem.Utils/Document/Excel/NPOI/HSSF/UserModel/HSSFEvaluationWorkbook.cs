...
namespace MUSystem.Utils.NPOI.HSSF.UserModel
{
    ...
    public class HSSFEvaluationWorkbook : IFormulaRenderingWorkbook, IEvaluationWorkbook, IFormulaParsingWorkbook
    {
        ...
        private MUSystem.Utils.NPOI.HSSF.Model.InternalWorkbook _iBook;

        public static HSSFEvaluationWorkbook Create(MUSystem.Utils.NPOI.SS.UserModel.IWorkbook book)
        {
            if (book == null)
            {
                return null;
