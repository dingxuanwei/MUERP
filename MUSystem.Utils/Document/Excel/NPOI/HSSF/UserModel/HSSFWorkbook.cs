...
namespace MUSystem.Utils.NPOI.HSSF.UserModel
{
    ...
    using MUSystem.Utils.NPOI.POIFS.FileSystem;
    using MUSystem.Utils.NPOI.SS.Formula;
    using MUSystem.Utils.NPOI.SS.Formula.PTG;
    using MUSystem.Utils.NPOI.SS.Formula.Udf;
    ...
    public class HSSFWorkbook : POIDocument, IWorkbook
    {
        ...
        public MUSystem.Utils.NPOI.SS.UserModel.ICreationHelper GetCreationHelper()
        {
        ...
        /// </summary>
        private class SheetRecordCollector : MUSystem.Utils.NPOI.HSSF.Record.Aggregates.RecordVisitor,IDisposable
        {
     ...
     */
        ...
        [NonSerialized]
        private MUSystem.Utils.NPOI.SS.UserModel.MissingCellPolicy missingCellPolicy = MUSystem.Utils.NPOI.SS.UserModel.MissingCellPolicy.RETURN_NULL_AND_BLANK;
        /// <summary>
        ...
        public MUSystem.Utils.NPOI.SS.UserModel.MissingCellPolicy MissingCellPolicy
        {
        ...
        public MUSystem.Utils.NPOI.SS.UserModel.ISheet GetSheetAt(int index)
        {
        ...
        public MUSystem.Utils.NPOI.SS.UserModel.ISheet GetSheet(String name)
        {
                                               ...
                                               int startRow, int endRow)
        {
            ...
            MUSystem.Utils.NPOI.SS.UserModel.IPrintSetup printSetup = sheet.PrintSetup;
        ...
        public MUSystem.Utils.NPOI.SS.UserModel.IFont CreateFont()
        {
        ...
        //public MUSystem.Utils.NPOI.SS.UserModel.Font FindFont(MUSystem.Utils.NPOI.SS.UserModel.FontBoldWeight boldWeight, short color, short fontHeight,
        //                 String name, bool italic, bool strikeout,
        //                 MUSystem.Utils.NPOI.SS.UserModel.FontSuperScript typeOffset, MUSystem.Utils.NPOI.SS.UserModel.FontUnderlineType Underline)
        //{
        ...
        /// <returns></returns>
        public MUSystem.Utils.NPOI.SS.UserModel.IFont FindFont(short boldWeight, short color, short fontHeight,
                         String name, bool italic, bool strikeout,
                         short typeOffset, byte Underline)
        {
            ...
            for (short i = 0; i <= this.NumberOfFonts; i++)
            {
                ...
                MUSystem.Utils.NPOI.SS.UserModel.IFont hssfFont = GetFontAt(i);
        ...
        public MUSystem.Utils.NPOI.SS.UserModel.IFont GetFontAt(short idx)
        {
        ...
        public MUSystem.Utils.NPOI.SS.UserModel.ICellStyle CreateCellStyle()
        {
        ...
        public MUSystem.Utils.NPOI.SS.UserModel.ICellStyle GetCellStyleAt(short idx)
        {
 ...
 */
        ...
        public MUSystem.Utils.NPOI.SS.UserModel.IName GetName(String name)
        {
        ...
        public MUSystem.Utils.NPOI.SS.UserModel.IName GetNameAt(int index)
        {
        ...
        /// </summary>
        /// <returns>named range high level</returns>
        public MUSystem.Utils.NPOI.SS.UserModel.IName CreateName()
        {
        ...
        public MUSystem.Utils.NPOI.SS.UserModel.IDataFormat CreateDataFormat()
        {
            if (formatter == null)
        ...
        public int AddPicture(byte[] pictureData, MUSystem.Utils.NPOI.SS.UserModel.PictureType format)
        {
            InitDrawings();
            ...
            switch (format)
            {
                case MUSystem.Utils.NPOI.SS.UserModel.PictureType.EMF:
                    blipRecord.Options = HSSFPictureData.MSOBI_EMF;
                    break;
                case MUSystem.Utils.NPOI.SS.UserModel.PictureType.WMF:
                    blipRecord.Options = HSSFPictureData.MSOBI_WMF;
                    break;
                case MUSystem.Utils.NPOI.SS.UserModel.PictureType.PICT:
                    blipRecord.Options = HSSFPictureData.MSOBI_PICT;
                    break;
                case MUSystem.Utils.NPOI.SS.UserModel.PictureType.PNG:
                    blipRecord.Options = HSSFPictureData.MSOBI_PNG;
                    break;
                case MUSystem.Utils.NPOI.SS.UserModel.PictureType.JPEG:
                    blipRecord.Options = HSSFPictureData.MSOBI_JPEG;
                    break;
                case MUSystem.Utils.NPOI.SS.UserModel.PictureType.DIB:
