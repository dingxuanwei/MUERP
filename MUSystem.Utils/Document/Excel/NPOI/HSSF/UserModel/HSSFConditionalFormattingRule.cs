...
namespace MUSystem.Utils.NPOI.HSSF.UserModel
{
    ...
    using MUSystem.Utils.NPOI.HSSF.Record.CF;
        ...
        public String Formula2
        {
            get
            {
                ...
                if (conditionType == CELL_COMPARISON)
                {
                    ...
                    {
                        case (byte)MUSystem.Utils.NPOI.SS.UserModel.ComparisonOperator.BETWEEN:
                        case (byte)MUSystem.Utils.NPOI.SS.UserModel.ComparisonOperator.NOT_BETWEEN:
