...
namespace MUSystem.Utils.NPOI.HSSF.Util
{
    using System;
    using System.Collections;
    using MUSystem.Utils.NPOI.HSSF.UserModel;
    ...
    public class HSSFCellUtil
    {
        ...
        public static MUSystem.Utils.NPOI.SS.UserModel.IRow GetRow(int rowCounter, HSSFSheet sheet)
        {
            MUSystem.Utils.NPOI.SS.UserModel.IRow row = sheet.GetRow(rowCounter);
            if (row == null)
            {
        ...
        public static MUSystem.Utils.NPOI.SS.UserModel.ICell GetCell(MUSystem.Utils.NPOI.SS.UserModel.IRow row, int column)
        {
            MUSystem.Utils.NPOI.SS.UserModel.ICell cell = row.GetCell(column);
        ...
        public static MUSystem.Utils.NPOI.SS.UserModel.ICell CreateCell(MUSystem.Utils.NPOI.SS.UserModel.IRow row, int column, String value, HSSFCellStyle style)
        {
            MUSystem.Utils.NPOI.SS.UserModel.ICell cell = GetCell(row, column);
        ...
        /// <param name="value">The value of the cell</param>
        /// <returns>A new HSSFCell.</returns>
        public static MUSystem.Utils.NPOI.SS.UserModel.ICell CreateCell(MUSystem.Utils.NPOI.SS.UserModel.IRow row, int column, String value)
        {
         ...
         */
        public static void SetCellStyleProperty(MUSystem.Utils.NPOI.SS.UserModel.ICell cell, HSSFWorkbook workbook, String propertyName, Object propertyValue)
        {
            MUSystem.Utils.NPOI.SS.UserModel.ICellStyle originalStyle = cell.CellStyle;
            MUSystem.Utils.NPOI.SS.UserModel.ICellStyle newStyle = null;
            ...
            {
                MUSystem.Utils.NPOI.SS.UserModel.ICellStyle wbStyle = workbook.GetCellStyleAt(i);
        ...
        private static Hashtable GetFormatProperties(MUSystem.Utils.NPOI.SS.UserModel.ICellStyle style)
        {
        ...
        private static void SetFormatProperties(
                MUSystem.Utils.NPOI.SS.UserModel.ICellStyle style, HSSFWorkbook workbook, Hashtable properties)
        {
            style.Alignment = (MUSystem.Utils.NPOI.SS.UserModel.HorizontalAlignment)GetShort(properties, ALIGNMENT);
            style.BorderBottom = (MUSystem.Utils.NPOI.SS.UserModel.BorderStyle)GetShort(properties, BORDER_BOTTOM);
            style.BorderLeft = (MUSystem.Utils.NPOI.SS.UserModel.BorderStyle)GetShort(properties, BORDER_LEFT);
            style.BorderRight = (MUSystem.Utils.NPOI.SS.UserModel.BorderStyle)GetShort(properties, BORDER_RIGHT);
            style.BorderTop = (MUSystem.Utils.NPOI.SS.UserModel.BorderStyle)GetShort(properties, BORDER_TOP);
            ...
            style.FillPattern = (MUSystem.Utils.NPOI.SS.UserModel.FillPatternType)GetShort(properties, FILL_PATTERN);
            ...
            style.VerticalAlignment = (MUSystem.Utils.NPOI.SS.UserModel.VerticalAlignment)GetShort(properties, VERTICAL_ALIGNMENT);
