...
namespace MUSystem.Utils.NPOI.HSSF.Extractor
{
    using System;
    using System.Text;
    using System.IO;
    ...
    using MUSystem.Utils.NPOI;
    using MUSystem.Utils.NPOI.HPSF;
    using MUSystem.Utils.NPOI.SS.Formula.Eval;
    using MUSystem.Utils.NPOI.HSSF.EventUserModel;
    ...
    public class EventBasedExcelExtractor : POIOLE2TextExtractor
    {
        ...
        private class TextListener : HSSFListener
        {
            ...
            private String FormatNumberDateCell(CellValueRecordInterface cell, double value)
            {
                ...
                {
                    // Is it a date?
                    if (MUSystem.Utils.NPOI.SS.UserModel.DateUtil.IsADateFormat(formatIndex, formatString) &&
                            MUSystem.Utils.NPOI.SS.UserModel.DateUtil.IsValidExcelDate(value))
                    {
                        ...
                        // Format as a date
                        DateTime d = MUSystem.Utils.NPOI.SS.UserModel.DateUtil.GetJavaDate(value, false);
