...
namespace MUSystem.Utils.NPOI.SS.Formula
{
    ...
    public class SheetNameFormatter
    {
        ...
        {
            return MUSystem.Utils.NPOI.SS.Util.CellReference.CellReferenceIsWithinRange(lettersPrefix, numbersSuffix, MUSystem.Utils.NPOI.SS.SpreadsheetVersion.EXCEL97);
        }
