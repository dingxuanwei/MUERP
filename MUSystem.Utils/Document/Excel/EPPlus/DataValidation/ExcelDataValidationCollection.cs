...
using MUSystem.Utils.EPPlus.Utils;
using System.Xml;
using MUSystem.Utils.EPPlus.DataValidation.Contracts;

namespace MUSystem.Utils.EPPlus.DataValidation
{
    /// <summary>
    /// <para>
    ...
    public class ExcelDataValidationCollection : XmlHelper, IEnumerable<IExcelDataValidation>
    {
        ...
        public bool Remove(IExcelDataValidation item)
        {
            ...
            {
                throw new InvalidCastException("The supplied item must inherit MUSystem.Utils.EPPlus.DataValidation.ExcelDataValidation");
            }
