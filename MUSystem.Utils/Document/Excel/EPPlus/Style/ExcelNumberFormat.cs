...
namespace MUSystem.Utils.EPPlus.Style
{
    ...
    {
        internal ExcelNumberFormat(ExcelStyles styles, MUSystem.Utils.EPPlus.XmlHelper.ChangedEventHandler ChangedEvent, int PositionID, string Address, int index) :
