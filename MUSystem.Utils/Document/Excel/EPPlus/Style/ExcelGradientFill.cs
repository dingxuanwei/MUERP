...
namespace MUSystem.Utils.EPPlus.Style
{
    ...
    {
        internal ExcelGradientFill(ExcelStyles styles, MUSystem.Utils.EPPlus.XmlHelper.ChangedEventHandler ChangedEvent, int PositionID, string address, int index) :
