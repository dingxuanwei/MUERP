...
namespace MUSystem.Utils.Ionic.Zip
{
    ...
    public class SelfExtractorSaveOptions
    {
        ...
        /// </para>
        /// </remarks>
        public MUSystem.Utils.Ionic.Zip.ExtractExistingFileAction ExtractExistingFile
        {
            get;
            set;
        }
    ...
    partial class ZipFile
    {
        ...
        private static ExtractorSettings[] SettingsList = {
            new ExtractorSettings() {
                ...
                CopyThroughResources = new List<string>{
                    "MUSystem.Utils.Ionic.Zip.WinFormsSelfExtractorStub.resources",
                    "MUSystem.Utils.Ionic.Zip.Forms.PasswordDialog.resources",
                    "MUSystem.Utils.Ionic.Zip.Forms.ZipContentsDialog.resources"},
        ...
        //         "namespace MUSystem.Utils.Ionic.Zip { public partial class WinFormsSelfExtractorStub { partial void _SetDefaultExtractLocation() {" +
        ...
        private void _SaveSfxStub(string exeToGenerate, SelfExtractorSaveOptions options)
        {
            ...
            try
            {
                ...
                // get the MUSystem.Utils.Ionic.Zip assembly
                ...
                using (var csharp = new Microsoft.CSharp.CSharpCodeProvider())
                {
                    ...
                    // This is the list of referenced assemblies.  MUSystem.Utils.Ionic.Zip is
                    ...
                    using (ZipFile zip = ZipFile.Read(a2.GetManifestResourceStream("MUSystem.Utils.Ionic.Zip.Resources.ZippedResources.zip")))
                    {
                        ...
                        {
                            // Use the ico file that is embedded into the MUSystem.Utils.Ionic.Zip
                        ...
                        // add the MUSystem.Utils.Ionic.Utils.Zip DLL as an embedded resource
