...
// generating zip files.  This class does not depend on MUSystem.Utils.Ionic.Zip.ZipFile, but rather
...
using System.IO;
using MUSystem.Utils.Ionic.Zip;
...
namespace MUSystem.Utils.Ionic.Zip
{
    ...
    public class ZipOutputStream : Stream
    {
        ...
        private void _Init(Stream stream, bool leaveOpen, string name)
        {
            ...
            Strategy = MUSystem.Utils.Ionic.Zlib.CompressionStrategy.Default;
            _name = name ?? "(stream)";
#if !NETCF
        ...
        ///   cref="MUSystem.Utils.Ionic.Zlib.CompressionStrategy "/>.
        /// </remarks>
        ...
        public bool UseUnicodeAsNecessary
        {
            ...
            set
            {
                ...
                {
                    _alternateEncoding = MUSystem.Utils.Ionic.Zip.ZipOutputStream.DefaultEncoding;
        ...
        ///     cref="MUSystem.Utils.Ionic.Zlib.CompressionLevel.BestSpeed"/>.  You may have to perform
        ...
        private MUSystem.Utils.Ionic.Crc.CrcCalculatorStream _entryOutputStream;
...
#if !NETCF
        public MUSystem.Utils.Ionic.Zlib.ParallelDeflateOutputStream ParallelDeflater
        {
            get
            {
