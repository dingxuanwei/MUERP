...
namespace MUSystem.Utils.Ionic.Zip
{
    ...
    partial class ZipFile
    {
                                               ...
                                               bool wantUpdate)
        {
            ...
            MUSystem.Utils.Ionic.FileSelector ff = new MUSystem.Utils.Ionic.FileSelector(selectionCriteria,
...
namespace MUSystem.Utils.Ionic
{
    internal abstract partial class SelectionCriterion
    {
        internal abstract bool Evaluate(MUSystem.Utils.Ionic.Zip.ZipEntry entry);
    }


    internal partial class NameCriterion : SelectionCriterion
    {
        internal override bool Evaluate(MUSystem.Utils.Ionic.Zip.ZipEntry entry)
        {
    ...
    {
        private bool Evaluate(MUSystem.Utils.Ionic.Zip.ZipEntry entry)
        {
        ...
        public ICollection<MUSystem.Utils.Ionic.Zip.ZipEntry> SelectEntries(MUSystem.Utils.Ionic.Zip.ZipFile zip)
        {
            if (zip == null)
                throw new ArgumentNullException("zip");

            var list = new List<MUSystem.Utils.Ionic.Zip.ZipEntry>();

            foreach (MUSystem.Utils.Ionic.Zip.ZipEntry e in zip)
            {
                if (this.Evaluate(e))
                    list.Add(e);
            }
        ...
        ///
        /// <returns>a collection of ZipEntry objects that conform to the criteria.</returns>
        public ICollection<MUSystem.Utils.Ionic.Zip.ZipEntry> SelectEntries(MUSystem.Utils.Ionic.Zip.ZipFile zip, string directoryPathInArchive)
        {
            if (zip == null)
                throw new ArgumentNullException("zip");
