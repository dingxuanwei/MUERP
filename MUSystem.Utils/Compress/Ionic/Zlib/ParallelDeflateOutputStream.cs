...
using MUSystem.Utils.Ionic.Zlib;
using System.IO;


namespace MUSystem.Utils.Ionic.Zlib
{
    internal class WorkItem
    {
        ...
        public WorkItem(int size,
                        MUSystem.Utils.Ionic.Zlib.CompressionLevel compressLevel,
    ...
    ///
    /// <para>
    ///   This class is similar to <see cref="MUSystem.Utils.Ionic.Zlib.DeflateStream"/>, except
    ...
    ///
    /// </remarks>
    /// <seealso cref="MUSystem.Utils.Ionic.Zlib.DeflateStream" />
    public class ParallelDeflateOutputStream : System.IO.Stream
    {
        ...
        private int                         _Crc32;
        private MUSystem.Utils.Ionic.Crc.CRC32             _runningCrc;
        ...
        private MUSystem.Utils.Ionic.Zlib.CompressionLevel _compressLevel;
        ...
        ///
        /// <para>
        ///   This class is similar to <see cref="MUSystem.Utils.Ionic.Zlib.DeflateStream"/>,
        ...
        ///   cref="MUSystem.Utils.Ionic.Zlib.DeflateStream"/>.  On the other hand, using a
        ...
        private void _InitializePoolOfWorkItems()
        {
            ...
            _runningCrc = new MUSystem.Utils.Ionic.Crc.CRC32();
            _currentlyFilling = -1;
            _lastFilled = -1;
            _lastWritten = -1;
            _latestCompressed = -1;
        ...
        ///
        /// <para>
        ///   To decompress data, use the <see cref="MUSystem.Utils.Ionic.Zlib.DeflateStream"/> class.
        /// </para>
        ///
        /// </remarks>
        ...
        private void _PerpetualWriterMethod(object state)
        {
            ...
            try
            {
                do
                {
                    ...
                    MUSystem.Utils.Ionic.Zlib.CRC32 c= new MUSystem.Utils.Ionic.Zlib.CRC32();
                    do
                    {
        ...
        private void _DeflateOne(Object wi)
        {
            ...
            try
            {
                ...
                MUSystem.Utils.Ionic.Crc.CRC32 crc = new MUSystem.Utils.Ionic.Crc.CRC32();
