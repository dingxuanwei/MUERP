...
// compile: msbuild
// not: csc.exe /t:library /debug+ /out:MUSystem.Utils.Ionic.BZip2.dll BZip2InputStream.cs BCRC32.cs Rand.cs
...
namespace MUSystem.Utils.Ionic.BZip2
{
    /// <summary>
    ...
    public class BZip2InputStream : System.IO.Stream
    {
        ...
        private int bsBuff;
        private int bsLive;
        private readonly MUSystem.Utils.Ionic.Crc.CRC32 crc = new MUSystem.Utils.Ionic.Crc.CRC32(true);
        private int nInUse;
        ...
        ///   {
        ///       using (var decompressor = new MUSystem.Utils.Ionic.BZip2.BZip2InputStream(fs))
        ///       {
