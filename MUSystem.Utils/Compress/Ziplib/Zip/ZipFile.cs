...
using MUSystem.Utils.ZipLib.Encryption;
#endif

using MUSystem.Utils.ZipLib.Core;
using MUSystem.Utils.ZipLib.Checksums;
using MUSystem.Utils.ZipLib.Zip.Compression.Streams;
using MUSystem.Utils.ZipLib.Zip.Compression;

namespace MUSystem.Utils.ZipLib.Zip 
{
	...
	/// using System.IO;
	/// 
	/// using MUSystem.Utils.ZipLib.Zip;
	/// 
	/// class MainClass
	/// {
	...
	public class ZipFile : IEnumerable, IDisposable
	{
		...
		/// </exception>
		/// <exception cref="MUSystem.Utils.ZipLib.Zip.ZipException">
