...
namespace MUSystem.Core
{
    public class APP
    {
        ...
        //配置自动更新的字段
        public static string FIELD_UPDATE_CODE = "UpdateCode";
        public static string FIELD_UPDATE_PERSON = "UpdatePerson";
        public static string FIELD_UPDATE_DATE = "UpdateDate";
        public static string FIELD_CREATE_CODE = "CreateCode";
        public static string FIELD_CREATE_PERSON = "CreatePerson";
        public static string FIELD_CREATE_DATE = "CreateDate";
        //增加部门 工厂编号
        public static string FIELD_DepNo = "DepNo";
        public static string FIELD_FactoryCode = "FactoryCode";

        //BLL的一些设置
        public static string SERVICE_BLL_NAMESPACE = "MUSystem.Models"; //指定bll层的命名空间
        public static string SERVICE_BLL_FILE_NAME = "MUSystem.Web"; //指定bll层所在的dll名称，如MUSystem.BLL.dll 则值为MUSystem.BLL
